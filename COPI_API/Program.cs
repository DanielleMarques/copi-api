...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("UsuarioPIGE", policy => policy.RequireRole("UsuarioPIGE"));
    options.AddPolicy("UsuarioExternoRevisor", policy => policy.RequireRole("UsuarioExternoRevisor"));
    options.AddPolicy("UsuarioExterno", policy => policy.RequireRole("UsuarioExterno"));
